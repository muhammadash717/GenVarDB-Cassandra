...
tsv_output = genebe_tsv.replace("_raw.tsv", "_annotation.tsv")
...
result = result.loc[:,[
    "chr", "pos", "ref", "alt", "acmg_classification", "gene_symbol", "OMIM", "OMIM_IDs", "effect", "hgvs_c", "hgvs_p",
    ...
    "Diseases_description", "HPO_IDs", "HPO_Terms", "Gene_description", "variant_samples"]]
...
result.to_csv(tsv_output, sep='\t', index=False)
